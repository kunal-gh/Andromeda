...
def ingest_refund_policy():
    policy_path = Path("app/data/andromeda_refund_policy.md")
    ...
    try:
        ...
        with open(policy_path, "r", encoding="utf-8") as f:
            content = f.read()
        doc = Document(page_content=content, metadata={"source": "andromeda_refund_policy.md", "type": "policy"})
